...
According to IEEE Software Engineering is {\em (1) The application of a systematic, disciplined, quantifiable approach to the development, operation, and maintenance of software; that is, the application of engineering to software. (2) The study of approaches as in (1)} \cite{A04}. In contrast to more established fields of CS, the field of SE is still rather immature and has seen a radical paradigmatic change in the past decade with the emergence of agile methodologies \cite{BA04,  KM02}. In contrast to traditional plan-based methods (e.g. the so-called Waterfall method \cite{R00}), agile methodologies emphasize working software, customer collaboration, human interaction and best technological practices.

It has lately been recognized that SE is more a craft than a science~\cite{M08} and as such it is to be treated differently than the more theory-based topics. The up-to-date industrial best practices and tools should be taken into account when teaching SE. It has been noticed that with a traditional university instruction students even need to unlearn working methods acquired in formal education when entering the industry~\cite{BS08, FP12}.
